...
export class EventService {
     ...
     * @param participate (optional) 
     * @return successful
     */
    postInvitationResponse(id: number, contactId?: number | null | undefined, organizationId?: number | null | undefined, passCode?: string | null | undefined, participate?: boolean | undefined): Observable<string> {
        ...
        if (passCode !== undefined && passCode !== null)
            url_ += "passCode=" + encodeURIComponent("" + passCode) + "&";
        if (participate === null)
            throw new Error("The parameter 'participate' cannot be null.");
        else if (participate !== undefined)
            url_ += "participate=" + encodeURIComponent("" + participate) + "&";
        url_ = url_.replace(/[?&]$/, "");
...
export class MailService {
     ...
     */
    sendInvitationMails(id: number, contactIds: number[], orgaIds?: number[] | null | undefined, mailContent?: string | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/Mail/events/{id}?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
