...
namespace WebApi.Controllers
{
    ...
    public class OrganizationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Put([FromBody]OrganizationDto organization, [FromRoute]long id)
        {
            ...
            await modService.UpdateOrganizationAsync(userOfChange, await _organizationService.GetByIdAsync(id), mappedOrganization, await userService.IsDatenschutzbeauftragter(userOfChange.Id));
