...
{
    public partial class ram_init_ds7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDeletionCheckDate", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "cee7a964-f397-4f12-94de-6d68a1b18f36", "Admin", "ADMIN", null });

            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "PermissionGroupId" },
                values: new object[] { 2L, "6486ee46-0a7d-4079-8847-323c1881b533", "DeleteUser", "DELETEUSER", null });
