<<<<<<< HEAD:backend/ModelLayer/Migrations/20200809103202_init.cs
﻿using System;
...
namespace ModelLayer.Migrations
{
    public partial class ds2_ram : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "4d3cdfc5-a993-441b-acd4-506d25a84844", "Admin", "ADMIN", null });

            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "PermissionGroupId" },
                values: new object[] { 2L, "e09e073e-c9d4-412f-89d0-fb42b71f2657", "DeleteUser", "DELETEUSER", null });
...
>>>>>>> DS2_2_ram:backend/ModelLayer/Migrations/20200724081635_ds2_ram.cs
