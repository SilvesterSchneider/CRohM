...
{
    public partial class ram_wwd12_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "e6f78684-6374-4733-be45-15280faa96ac", "Admin", "ADMIN", null });

            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "PermissionGroupId" },
                values: new object[] { 2L, "b2e41df9-02fa-4a25-8ba9-2f8e5ddfca8c", "DeleteUser", "DELETEUSER", null });
